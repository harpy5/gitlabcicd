...
lab = client.create_lab(title="CML_Automation_Lab_using_docker")                                #Ceate a lab
...
external_conn = lab.create_node("ext_con", "external_connector", -50, -50)
ext_interface = external_conn.create_interface()
external_conn.config = "bridge701"
...
unmanaged_sw=lab.create_node("unmgd_sw", "unmanaged_switch", -50, 100)
...
unmgd_sw_i3 = unmanaged_sw.create_interface()
unmgd_sw_i4 = unmanaged_sw.create_interface()
unmgd_sw_i5 = unmanaged_sw.create_interface()

lab.create_link(dist_sw1_i1, unmgd_sw_i1)
lab.create_link(dist_sw2_i1, unmgd_sw_i2)          # mgmnt0 link to unmgd sw
lab.create_link(unmgd_sw_i4, R1_i5)
lab.create_link(unmgd_sw_i5, R2_i5)
lab.create_link(unmgd_sw_i3, ext_interface)
...
lab = client.find_labs_by_title('CML_Automation_Lab_using_docker')[0]
...
R2_config.configure('''
      ...
      interface GigabitEthernet0/4
       ...
       ip address 10.85.48.139 255.255.255.128
       no shut
       duplex auto
       speed auto
      !
...
R1_config.configure('''
      ...
      interface GigabitEthernet0/4
       ip vrf forwarding management
       ip address 10.85.48.140 255.255.255.128
       no shut
       duplex auto
       speed auto
      !
...
SW1_config.configure('''
      ...
      vlan 10
       ...
       vrf context management
        ip route 0.0.0.0 0.0.0.0 10.85.48.129
      vpc domain 10
        role priority 10
